...
export default function HelpVerificationPage() {
  return (
    <PlaceholderPage
      ...
      description="This route will explain the V1 verification model: email verification first, then either hosted identity verification or refundable deposit verification."
      bullets={[
        ...
        "Raw identity document images are explicitly out of bounds for app storage."
      ]}
      links={[
